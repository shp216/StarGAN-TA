...
# img = Image.open("Original_jpg/tak.jpg").convert("RGB")
...
#   pre_X, pre_Y = x, y
# # face[fa[0][1]].append(fa[-1][0])
# # face[fa[-1][1]].append(fa[-1][0])
...
# # x1, x2 = face[min(face.keys())+2]
# # for y in range(min_y, min(face.keys())):
# #   white[y][x1 : x2+1] = ima[y][x1 : x2+1]
